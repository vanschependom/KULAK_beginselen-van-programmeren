...
def main():
    ...
    feest.voegComitelidToe(
        Comitelid("Peter Selie", "Kortrijkstraat 402, 8510 Marke"))
    feest.voegComitelidToe(
        Comitelid("Cas Tanje", "Heirbaan 2298, 8520 Kuurne"))
    feest.voegComitelidToe(
        Comitelid("May O'Naise", "Mellestraat 1, 8501 Heule"))
    feest.voegComitelidToe(
        Comitelid("Peter Selie", "Kortrijkstraat 215, 8510 Marke"))
    ...
    try:
        ...
        print("Lege string!")
        print("( -> "+e.args[0]+")")
    print("Doe verder met de rest van je programma!")
